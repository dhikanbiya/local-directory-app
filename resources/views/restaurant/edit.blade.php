...
<form method="POST" action="{{route('restaurant.update',$row->id)}}" enctype="multipart/form-data">
...
<div class="col-md-6 col-md-offset-2">
	...
	<div class="form-group">
	  ...
	  <textarea class="form-control" rows="5" name="information">{{$row->promotion}}</textarea>
	</div>
